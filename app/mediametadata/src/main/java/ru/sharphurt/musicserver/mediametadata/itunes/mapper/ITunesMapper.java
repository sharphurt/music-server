...
import ru.sharphurt.musicserver.mediametadata.util.ProxyUrlUtils;
...
public class ITunesMapper {
    ...
    public TrackEntity mapToTrackDto(ITunesTrackDto dto) {
        String previewUrl = ProxyUrlUtils.buildProxyUrl(dto.previewUrl(), serverBaseUrl);
        String rawImageUrl = ProxyUrlUtils.buildProxyUrl(dto.artworkUrl100()
